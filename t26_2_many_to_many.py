...
# give a User 'wendy' some blog posts
...
# storing keywords uniquely in the database
post.keywords.append(Keyword('wendy'))
post.keywords.append(Keyword('firstpost'))

# use the any operator to locate “blog posts where any of its keywords has the keyword string ‘firstpost'"
...
# look up posts owned by the user wendy, we can tell the query to narrow down to that User object as a parent:
result = session.query(BlogPost).\
